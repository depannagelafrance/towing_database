...
INSERT INTO P_ALLOTMENT_DIRECTION_INDICATORS(allotment_directions_id, name) 
SELECT id, 'Bollivartunnel' FROM P_ALLOTMENT_DIRECTIONS WHERE name='A112 > Gent'; 

INSERT INTO P_ALLOTMENT_MAP(allotment_id, direction_id, indicator_id)
SELECT 1, allotment_directions_id, id FROM P_ALLOTMENT_DIRECTION_INDICATORS WHERE name = 'Bollivartunnel';
